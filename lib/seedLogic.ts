...
export async function seedDatabase() {
  try {
    ...
    const doctorsData = [
      ...
      { name: "Dr. Aarti Mehta", specialization: specMap["Cardiology"], experience: 12, rating: 4.8, reviews: 210, location: "Max Health, Delhi", availabilityStatus: "Available", nextAvailable: "Tomorrow, 10:00 AM", image: "https://images.unsplash.com/photo-1594824436998-ddf1f7d1a29b?auto=format&fit=crop&w=600&q=80" },
      ...
      { name: "Dr. Nisha Patel", specialization: specMap["Pediatrics"], experience: 6, rating: 4.6, reviews: 130, location: "City Clinic, Delhi", availabilityStatus: "Busy", nextAvailable: "Next Week", image: "https://images.unsplash.com/photo-1594824436998-ddf1f7d1a29b?auto=format&fit=crop&w=600&q=80" },
      ...
      // Ophthalmology (3)
      { name: "Dr. Ritu Sharma", specialization: specMap["Ophthalmology"], experience: 12, rating: 4.8, reviews: 290, location: "Centre for Sight, Delhi", availabilityStatus: "Available", nextAvailable: "Today, 4:00 PM", image: "https://images.unsplash.com/photo-1594824436998-ddf1f7d1a29b?auto=format&fit=crop&w=600&q=80" },
      ...
      { name: "Dr. Preeti Kaur", specialization: specMap["General Medicine"], experience: 6, rating: 4.5, reviews: 150, location: "Fortis, Delhi", availabilityStatus: "Available", nextAvailable: "Today, 4:30 PM", image: "https://images.unsplash.com/photo-1594824436998-ddf1f7d1a29b?auto=format&fit=crop&w=600&q=80" },
      ...
      { name: "Dr. Naveen Prakash", specialization: specMap["Surgery"], experience: 20, rating: 4.9, reviews: 520, location: "Fortis, Delhi", availabilityStatus: "Busy", nextAvailable: "Next Mon, 8:00 AM", image: "https://images.unsplash.com/photo-1537368910025-700350fe46c7?auto=format&fit=crop&w=600&q=80" },
      { name: "Dr. Priyanka Shah", specialization: specMap["Surgery"], experience: 7, rating: 4.6, reviews: 140, location: "Max Health, Delhi", availabilityStatus: "Available", nextAvailable: "Today, 3:00 PM", image: "https://images.unsplash.com/photo-1594824436998-ddf1f7d1a29b?auto=format&fit=crop&w=600&q=80" },
    ];
